...
/* UndoDecorator class. */
var UndoDecorator = function (command, undoStack) {  // implements ReversiableCommand
...
var downButton = new CommandButton('Down', upCommand, body);
var LeftButton = new CommandButton('Left', upCommand, body);
var rightButton = new CommandButton('Right', upCommand, body);
